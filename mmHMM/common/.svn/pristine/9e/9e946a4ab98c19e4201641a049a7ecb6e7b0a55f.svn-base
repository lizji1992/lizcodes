...
#ifndef THREE_STATE_HDHMM_LINEAR_HPP
#define THREE_STATE_HDHMM_LINEAR_HPP
...
class ThreeStateHDHMMLinear {
public:
    ThreeStateHDHMMLinear(
...
private:
    ...
    std::vector<std::vector<size_t> > forward_gain_cps;
    std::vector<std::vector<size_t> > forward_loss_cps;
    std::vector<std::vector<size_t> > backward_gain_cps;
    std::vector<std::vector<size_t> > backward_loss_cps;
