...
#ifndef TWO_STATE_HDHMM_LINEAR_HPP
#define TWO_STATE_HDHMM_LINEAR_HPP
...
private:
   ...
   //  HMM internal data 
    ...
    std::vector<std::vector<size_t> > forward_support_points;
    std::vector<std::vector<size_t> > backward_support_points;
